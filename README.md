...
> `天才也非不学就会`——学习任何知识，无论是计算机，还是数学、物理等理论性抽象性很强的学科，都像柯南探案一样，只有在了解了 A、B、C、D 所有的线索之后，才能自然而然地理解整个事件的原貌，任何线索缺一不可。反之，如果你感觉学不会，那就是还欠缺了许多的前备知识，此时，盲目地感受挫败、或者没有把基础打好就进行下一步的学习是极度危险的！学习任何学科，确实就像拼图一样！一幅 20 块的拼图，你找到了边角的几块，才能推测出紧挨着他们、中间一些的几块是什么；很多人一学就会，是因为“胜利的拼图已经集齐”，很容易就找到最后一块。如果边角还没处理好，直接就跟着别人一样拼中间部分，那么四周没有邻居拼图，任谁也想象不出来最中间应该是什么、整体图像是怎样。
> （数学第一定律）无论是牛顿、高斯、伽罗瓦、爱因斯坦，他们都不是从 0 开始创造了所有的理论，原创的只是少数——他们通过学习获得的知识体系的量大大超过了他们原创的数学方法。正确地选取学习顺序、不因一时地挫败而情绪化地自暴自弃是学会的关键——*这也说明了一个合理的学习路径的重要性。*
